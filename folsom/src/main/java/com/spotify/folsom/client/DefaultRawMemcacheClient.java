...
public class DefaultRawMemcacheClient extends AbstractRawMemcacheClient {
    ...
    public static CompletionStage<RawMemcacheClient> connect(final HostAndPort address, final int outstandingRequestLimit, final int eventLoopThreadFlushMaxBatchSize, final boolean binary, final Executor executor, final long connectionTimeoutMillis, final Charset charset, final Metrics metrics, final int maxSetLength, final EventLoopGroup eventLoopGroup, final Class<? extends Channel> channelClass, final SSLEngineFactory sslEngineFactory) {
    ...
    private DefaultRawMemcacheClient(final HostAndPort address, final Channel channel, final int outstandingRequestLimit, final int eventLoopThreadFlushMaxBatchSize, final Executor executor, final long connectionTimeoutMillis, final Metrics metrics, int maxSetLength) {
    ...
    private class ConnectionHandler extends ChannelDuplexHandler {
        ...
        private final TimeoutChecker<Request<?>> connectionTimeoutChecker = TimeoutChecker.create(MILLISECONDS, connectionTimeoutMillis);
